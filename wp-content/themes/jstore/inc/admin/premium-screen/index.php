...
<div class="pho-premium-wrapper">
	...
	<div class="premium-contnt">
		...
		<div class="pho-premium-head">
			...
			<p> <?php printf( esc_html__( 'Premium', 'jstore' ) ); ?> <span> <?php printf( esc_html__( 'Theme', 'jstore' ) ); ?> </span> </p>
			<a href="https://www.phoeniixx.com/product/jstore-theme/" class="button btn-buy-now" target="_blank"><?php esc_html_e( 'Buy Now', 'jstore' ); ?></a>
			<a href="http://themes.phoeniixxdemo.com/?theme=jstore" class="button live-demo" target="_blank"><?php esc_html_e( 'Live Demo', 'jstore' ); ?></a>
